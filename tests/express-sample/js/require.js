...
(function(ba) {
  ...
  function B(b, c, d, m) {
    ...
    c.requireType = b;
    c.requireModules = m;d && (c.originalError = d);return c
  }
  function ia(b) {
    function c(a, f, C) {
      var e,
      ...
      if (C && l && (g || h)) {
        ...
        !c &&
        T && (c = T, d = k);c && (f.splice(0, d, c), a = f.join("/"))
      }
      return a
    }
    function d(a) {
    ...
    function g(a) {
      var f,
        b = a ? a.indexOf("!") : -1;
      -1 < b && (f = a.substring(0, b), a = a.substring(b + 1, a.length));return [f, a]
    }
    function l(a,
      f, b, e) {
      var n,
      ...
      a = g(a);
      i = a[0];
      a = a[1];i && (i = c(i, d, e), D = m(r, i));a && (i ? j = D && D.normalize ? D.normalize(a, function(a) {
        return c(a, d, e)
      }) : c(a, d, e) : (j = c(a, d, e), a = g(j), i = a[0], j = a[1], b = !0, n = k.nameToUrl(j)));
      b = i && !D && !b ? "_unnormalized" + (O += 1) : "";return {
        prefix: i,
        name: j,
        parentMap: f,
        unnormalized: !!b,
    ...
    function s(a) {
      var f = a.id,
        b = m(q, f);
      b || (b = q[f] = new k.Module(a));return b
    }
    function u(a, f, b) {
      var e = a.id,
        n = m(q,
          e);
      if (t(r, e) && (!n || n.defineEmitComplete)) {
        "defined" === f && b(r[e]);
      } else if (n = s(a), n.error && "error" === f) {
        b(n.error);
      } else {
        n.on(f, b)
      }
    ...
    function E() {
      var a,
        ...
        b,
        e,
        n = (b = 1E3 * j.waitSeconds) && k.startTime + b < (new Date).getTime(),
        c = [],
        i = [],
        g = !1,
        l = !0;
      if (!X) {
        X = !0;H(W, function(b) {
          ...
          if (b.enabled && (a.isDefine || i.push(b), !b.error)) {
            if (!b.inited && n) {
              p(f) ? g = e = !0 : (c.push(f), d(f));
            } else if (!b.inited && (b.fetched && a.isDefine) && (g = !0, !a.prefix)) {
              return l = !1
            }
          }
        });
        if (n && c.length) {
          return b = B("timeout", "Load timeout for modules: " + c, null, c), b.contextName = k.contextName, w(b);
        }
        l && z(i, function(a) {
          G(a, {}, {})
        });
    ...
    function L(a) {
      ...
      b = k.onScriptError;(!a.detachEvent || Z) && a.removeEventListener("error", b, !1);return {
        node: a,
    ...
    $.prototype = {
      init: function(a, b, c, e) {
        ...
        if (!this.inited) {
          ...
          if (c) {
            ...
            this.events.error && (c = v(this, function(a) {
              this.emit("error", a)
            }));
          }
            ...
            if (this.error) {
              ...
              if (!this.defining) {
                ...
                if (1 > this.depCount && !this.defined) {
                  ...
                  this.exports = e;
                  if (this.map.isDefine && !this.ignore && (r[c] = e, h.onResourceLoad)) {
                    h.onResourceLoad(k, this.map, this.depMaps);
                  }
                  y(c);
                  this.defined = !0
                }
      ...
      callPlugin: function() {
        var a = this.map,
          b = a.id,
          d = l(a.prefix);
        this.depMaps.push(d);u(d, "defined", v(this, function(e) {
          var n,
            d;
          d = this.map.name;
          ...
          if (this.map.unnormalized) {
            ...
            n = v(this, function(a) {
              ...
              this.inited = !0;
              this.error = a;
              a.requireModules = [b];H(q, function(a) {
              ...
              var d = a.name,
                g = l(d),
                i = Q;
              c && (e = c);i && (Q = !1);s(g);t(j.config, b) && (j.config[d] = j.config[b]);try {
                h.exec(e)
              } catch (D) {
                return w(B("fromtexteval",
                  "fromText eval for " + b + " failed: " + D, D, [b]))
              } i && (Q = !0);this.depMaps.push(g);k.completeLoad(d);C([d], n)
            }), e.load(a.name, C, n, j)
          }
        }));k.enable(d, this);
      ...
      enable: function() {
        W[this.map.id] = this;
        this.enabling = this.enabled = !0;z(this.depMaps, v(this, function(a, b) {
          var c,
            e;
          if ("string" === typeof a) {
            ...
            this.depCount += 1;u(a, "defined", v(this, function(a) {
              this.defineDep(b,
                a);this.check()
            }));this.errback && u(a, "error", v(this, this.errback))
          }
          c = a.id;
          e = q[c];!t(P, c) && (e && !e.enabled) && k.enable(a, this)
    ...
    k = {
      ...
      configure: function(a) {
        ...
        H(a, function(a, b) {
          ...
          c[b] = a
        }), j.shim = c);a.packages && (z(a.packages, function(a) {
          a = "string" === typeof a ? {
            name: a
          } : a;
          b[a.name] = {
      ...
      makeRequire: function(a, f) {
        function d(e, c, g) {
          ...
          if ("string" === typeof e) {
            ...
            if (h.get) {
              return h.get(k, e, a, d);
            }
            i = l(e, a, !1, !0);
            i = i.id;return !t(r, i) ? w(B("notloaded", 'Module name "' + i + '" has not been loaded yet for context: ' + b + (a ? "" : ". Use require([])"))) : r[i]
          }
          M();k.nextTick(function() {
            M();
            j = s(l(null, a));
            j.skipMap = f.skipMap;j.init(e, c, g, {
              enabled: !0
            });E()
          });return d
        }
        f = f || {};S(d, {
          ...
          specified: function(b) {
            b = l(b, a, !1, !0).id;return t(r, b) || t(q, b)
          }
        ...
        if (h.jsExtRegExp.test(a)) {
          ...
          for (k = i.length; 0 < k; k -= 1) {
            if (p = i.slice(0, k).join("/"), l = m(g, p), p = m(d, p)) {
              K(p) && (p = p[0]);i.splice(0, k, p);break
            } else if (l) {
              a = a === l.name ? l.location + "/" + l.main : l.location;i.splice(0, k, a);break
            }
          }
          i = i.join("/");
          i += b || (/\?/.test(i) || c ? "" : ".js");
      ...
      onScriptLoad: function(a) {
        if ("load" === a.type || la.test((a.currentTarget || a.srcElement).readyState)) {
          R = null, a = L(a), k.completeLoad(a.id)
        }
      },
  ...
  if ("undefined" === typeof define) {
    ...
    h = requirejs = function(b, c, d, p) {
      var g,
        l = "_";
      !K(b) && "string" !== typeof b && (g = b, K(c) ? (b = c, c = d, d = p) : b = []);g && g.context && (l = g.context);(p = m(G, l)) || (p = G[l] = h.s.newContext(l));g && p.configure(g);return p.require(b, c, d)
    };
    h.config = function(b) {
      return h(b)
    };
    ...
    x = h.s = {
      contexts: G,
      newContext: ia
    };h({});z(["toUrl", "undef", "defined", "specified"], function(b) {
      h[b] = function() {
        var c = G._;
        return c.require[b].apply(c, arguments)
      }
    });
    if (A && (y = x.head = document.getElementsByTagName("head")[0], E = document.getElementsByTagName("base")[0])) {
      y = x.head = E.parentNode;
    }
    h.onError = ca;
    h.load = function(b, c, d) {
      ...
      if (L = b.getAttribute("data-main")) {
        return s = L, u.baseUrl || (F = s.split("/"), s = F.pop(), ga = F.length ? F.join("/") + "/" : "./", u.baseUrl = ga), s = s.replace(fa, ""), h.jsExtRegExp.test(s) && (s = L), u.deps = u.deps ? u.deps.concat(s) : [s], !0
      }
    });
    define = function(b, c, d) {
      ...
      K(c) || (d = c, c = null);!c && J(d) && (c = [], d.length && (d.toString().replace(ma, "").replace(na, function(b, d) {
        c.push(d)
      }), c = (1 === d.length ? ["require"] : ["require", "exports", "module"]).concat(c)));
      if (Q) {
        if (!(h = M)) {
          R && "interactive" === R.readyState || O(document.getElementsByTagName("script"), function(b) {
