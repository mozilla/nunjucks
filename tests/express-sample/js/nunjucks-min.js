(function() {
  ...
  (function() {
    function extend(cls, name, props) {
      var F = function() {};
      F.prototype = cls.prototype;var prototype = new F;
      ...
      prototype.typename = name;var new_cls = function() {
        if (prototype.init) {
    ...
    exports.TemplateError = function(message, lineno, colno) {
      ...
      err.Update = function(path) {
        ...
        this.firstUpdate = false;return this
      };return err
    };
    ...
    if (!Array.prototype.indexOf) {
      Array.prototype.indexOf = function(array, searchElement) {
        if (array == null) {
          throw new TypeError
        }
        var t = Object(array);
    ...
    function makeKeywordArgs(obj) {
      obj.__keywords = true;return obj
    }
    ...
    function SafeString(val) {
      ...
      this.length = val.length;var methods = ["charAt", "charCodeAt", "concat", "contains", "endsWith", "fromCharCode", "indexOf", "lastIndexOf", "length", "localeCompare", "match", "quote", "replace", "search", "slice", "split", "startsWith", "substr", "substring", "toLocaleLowerCase", "toLocaleUpperCase", "toLowerCase", "toUpperCase", "trim", "trimLeft", "trimRight"];
        ...
        lib.asyncIter(arr, function(item, i, next) {
          switch (dimen) {
            case 1:
              ...
              break;default:
              item.push(i, next);iter.apply(this, item)
          }
        }, cb)
      } else {
          ...
          for (var i = 0; i < arr.length; i++) {
            ...
            switch (dimen) {
              case 1:
                ...
                break;default:
                item.push(i, done);func.apply(this, item)
            }
          }
        }
      } else {
    ...
    var Loader = Obj.extend({
      on: function(name, func) {
        ...
        this.listeners[name] = this.listeners[name] || [];this.listeners[name].push(func)
      },
      emit: function(name) {
    ...
    var WebLoader = Loader.extend({
      ...
      fetch: function(url, callback) {
        ...
        url += (url.indexOf("?") === -1 ? "?" : "&") + "s=" + (new Date).getTime();ajax.open("GET", url, false);ajax.send();return src
      }
    });
    modules["web-loaders"] = {
      WebLoader: WebLoader
    ...
    var filters = {
      ...
      replace: function(str, old, new_, maxCount) {
        ...
        while (last != res) {
          ...
          last = res;
          res = res.replace(old, new_);count++
        }
        return r.copySafeness(str, res)
      },
      ...
      truncate: function(input, length, killwords, end) {
        ...
        input += end !== undefined && end !== null ? end : "...";return r.copySafeness(orig, input)
      },
      upper: function(str) {
    ...
    function joiner(sep) {
      sep = sep || ",";var first = true;
      return function() {
        var val = first ? "" : sep;
        first = false;return val
      }
    }
    var globals = {
    ...
    var Environment = Obj.extend({
      ...
      addExtension: function(name, extension) {
        ...
        this.extensions[name] = extension;this.extensionsList.push(extension)
      },
    ...
    var Context = Obj.extend({
      ...
      addBlock: function(name, block) {
        this.blocks[name] = this.blocks[name] || [];this.blocks[name].push(block)
      },
    ...
    var Template = Obj.extend({
      ...
      getExported: function(cb) {
        ...
        this.rootRenderFunc(this.env, context, new Frame, runtime, function() {
      ...
      _compile: function() {
        ...
        if (this.tmplProps) {
          ...
          var source = compiler.compile(this.tmplStr, this.env.asyncFilters, this.env.extensionsList, this.path);
