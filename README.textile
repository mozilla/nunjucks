...
p. To compile templates, you have to use the lower-level API right now (very subject to change, a high-level API is coming soon):

bc. var parser = require('./parser');
var compiler = require('./compiler');
var c = new compiler.Compiler();
c.compiler(parser.parse('Hello {{ user }}'));

var tmpl = c.getCode();
console.log(compiler.render(tmpl, { user: 'James' }));