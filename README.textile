...
{{ messages('black') }} {# Call a function #}
{{ header|title|big }} {# Use a few filters #}
...
This is very early code. The parser is mostly complete and the code generator is being worked on. The biggest missing features are specific blocks like @import@, @block@, @extends@, etc.
